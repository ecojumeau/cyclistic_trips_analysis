...
library(ggplot2)
getwd()
setwd("C:/Users/contr/OneDrive/Documentos/Cyclistic Trips")
```
...
```{r Merging data}
all_trips <- bind_rows(nov_2021,dec_2021,jan_2022,feb_2022,mar_2022,apr_2022,may_2022,jun_2022,jul_2022,aug_2022,sep_2022,oct_2022)
```
